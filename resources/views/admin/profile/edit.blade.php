            ...
            <form action="{{ action('Admin\EccController@update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2"><nobr>
                        <select name="year" value="{{ $profile_form->year }}">
                        ...
                        年
                        <select name="month" value="{{ $profile_form->month }}">
                        ...
                        月
                        <select name="day" value="{{ $profile_form->day }}">
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <select name="time" value="{{ $profile_form->time }}">
